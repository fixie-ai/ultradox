---
title: 'WebSocket Integration TODO'
...
For more information about WebRTC and Phone, consult the [Telephony](/telephony/overview) guide.
...
See [Data Messages](/protocol/datamessages) for more information on all available messages.

<Note>
<b>Data Messages</b>
<br />
WebSocket connections use the same message format as WebRTC data channels. See our [Data Messages](/protocol/datamessages) documentation for detailed message specifications.
</Note>