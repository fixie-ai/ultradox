...
Using built-in tools is the same as using any other [custom durable tool](./durable-vs-temporary-tools) that you have created except for one difference: you can override built-in tools by using the same name.
