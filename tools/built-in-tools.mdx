...
<ParamField body="holdMusicUrl" type="string | null">
  ...
  Default: Defaults to <audio controls><source src="https://storage.googleapis.com/fixie-web-public/defaultHold.mp3" type="audio/mpeg" />"https://storage.googleapis.com/fixie-web-public/defaultHold.mp3"</audio>
</ParamField>
