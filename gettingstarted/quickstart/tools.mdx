...
1. Dig into [HTTP vs. Client Tools](/tools/http-vs-client-tools) to understand the differences.
1. Read about [Durable vs. Temp Tools](/tools/durable-vs-temporary-tools).