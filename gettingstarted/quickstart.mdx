...
Ultravox Realtime enables you connect your voice AI agents via [telephony providers](/telephony/overview), [Websockets](/protocol/websockets), [SIP trunks](/telephony/sip), or in [web/native apps](/apps/overview).
</Note>
...
**Want the complete working example?** Check out our [detailed outbound calls guide](/getting-started/outbound-calls) with full setup instructions, error handling, and more.
...
- **[Incoming Phone Calls](/examples)** - Handle inbound calls with AI agents
- **[Web Voice Chat](/examples)** - Add voice AI directly to your website
- **[Call Transfers](/examples)** - Route calls between AI and human agents
- **[Custom Tools](/examples)** - Give your agents special capabilities
- **[Multi-Provider Setup](/examples)** - Use Telnyx, Plivo, or other providers
...
- Set up [incoming calls](/telephony/incoming-calls) to handle inbound traffic
...
- Add [custom tools](/essentials/tools) to give your agents special capabilities
- Set up [webhooks](/webhooks/overview) for real-time call notifications

## Need Help?

- **Discord**: Join our [community](https://discord.gg/ultravox) for real-time support
