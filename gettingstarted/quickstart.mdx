...
- Learn about [Telephony Providers](/telephony/telephony-platforms) or [SIP](/telephony/sip).
...
### For Web and Native Integrations:
- Try our [WebRTC SDK](/apps/sdks) for WebRTC-based voice chat
