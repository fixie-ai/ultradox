...
### Tools
Tools are how your model interacts with the outside world, but you have to help the model understand when and how those [tools](/essentials/tools) should be used. Here's a good pattern for prompting the model to use a tool:
