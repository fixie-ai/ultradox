---
title: 'Outgoing Phone Calls'
description: 'Connect outoing Twilio calls to an Ultravox agent in 5 minutes or less.'
...
<Steps>
  <Step title="Get the Source Code">
    Copy all the code locally from the [`twilio-outgoing-quickstart-js`](https://github.com/fixie-ai/ultradox/tree/main/examples/twilio-outgoing-quickstart-js) example.
  </Step>
