...
| [Transcript](#transcript)                     | Server | Contains text transcripts of audio.                  |
...
## Transcript
A message containing text transcripts of user and agent audio utterances.
- `type: "transcript"`
...
- `final`: Boolean. Whether more updates expected. Whether to expect additional transcript messages for this conversation round.
...
- `result`: String. Tool execution result (optional).
