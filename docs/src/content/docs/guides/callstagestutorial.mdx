...
1. **Define the Tool** → Create a schema for escalation requests
1. **Create Manager Handler** → Build the API route for manager takeover
1. **Update System Prompt** → Add escalation rules to the base prompt
1. **Test the System** → Verify escalation flows
</Steps>
...
- [Call Stages Reference](https://docs.ultravox.ai/guides/stages)
- [Tutorial Source Code](https://github.com/fixie-ai/ultravox-tutorial-call-stages)
- [Client Tools Tutorial](https://docs.ultravox.ai/guides/clienttoolstutorial)