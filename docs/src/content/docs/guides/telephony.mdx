...
<table class="w-full">
    ...
    <tr>
        ...
        <td>string</td>
        <td>Tells Ultravox who should talk first when the call starts. For outgoing calls, typically set to `"FIRST_SPEAKER_USER"`. Default is `"FIRST_SPEAKER_AGENT"`.</td>
    </tr>
</table>
