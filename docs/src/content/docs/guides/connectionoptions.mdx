...
<table class="w-full">
    ...
    <tr>
        ...
        <td>string</td>
        <td>Tells Ultravox who should speak first. For outgoing calls, typically set to `"FIRST_SPEAKER_USER"`. The defaul is `"FIRST_SPEAKER_AGENT"`.</td>
    </tr>
</table>
...
async for message in socket:
    if isinstance(message, bytes):
        ...
        # Handle data message. See *insert link to /datamessages*.
