...
description: Use Ultravox to make and receive calls using WebRTC, telephony, or direct WebSocket connections.
---
...
### Best Practices
1. Always test your integration thoroughly in a development environment before deploying to production
2. Implement proper error handling and fallback logic
3. Monitor call quality and connection stability
4. Ensure your system can handle the audio stream bidirectionally
5. Consider implementing reconnection logic for dropped connections
