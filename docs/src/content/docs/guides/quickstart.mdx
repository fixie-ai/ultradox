...
Here is a simple demo of a complete call. Full source code for this application can be found in the [`examples`](https://github.com/fixie-ai/ultradox/tree/main/examples/simple-vanilla-html) folder.
