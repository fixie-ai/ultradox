...
unmuteMic(): void
```
Un mutes the end user's microphone. This is scoped to the Ultravox SDK.
...
unmuteSpeaker(): void
```
Un mutes the end user's speaker (the agent's voice output). This is scoped to the Ultravox SDK.
