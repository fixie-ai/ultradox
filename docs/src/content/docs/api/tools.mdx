...
## Tools Quickstart
The fastest way to get started with tools is to pass them in when you call [`Create Call`](../calls/#create-call) in the request body:
...
Iteration is faster when using temporary tools.
...
## Durable Tools
In addition to temporary tools, Ultravox supports the creation of durable tools. There is no functional difference between durable and temporary tools.
