...
1. If user interacts, call continues. If no user interaction occurs for another 30 seconds, agent says "If there's nothing else, may I end the call?".
1. If no user interaction occurs for another 45 seconds, agent says the provided message and the call ends unless the agent is interrupted during this final message.
</Steps>
