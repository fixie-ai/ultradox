...
that count toward the SIP duration while the blue block shows when your agent is connected.
...
gantt
    ...
    section Agent
    Connected         :active, 20000, 30000ms
```
...
gantt
    ...
    section SIP Call
    Talking to Agent           :crit, 0, 30000ms

    section Agent
    Connected         :active, 0, 30000ms
```
