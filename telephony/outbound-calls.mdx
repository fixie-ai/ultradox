...
<Steps>
  <Step title="Configure Provider Credentials">
    Set up your Twilio, Telnyx, or Plivo account credentials in your Ultravox account.
  </Step>
...
<Info>
  For outbound calls, make sure to set [`firstSpeakerSettings`](#firstspeakersettings) to `user`.
</Info>
...
{
  "systemPrompt": "You are calling to remind {{customerName}} about their appointment.",
  "templateContext": {
    ...
    ```js Twilio Outgoing
    {
      "twilio": {
        "outgoing": {
          ...
          "from": "+15559876543",      // Your Twilio phone number
