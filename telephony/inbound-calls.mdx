...
When handling telphony webhooks yourself, this data might come from an IVR or your own application. You then specify it as normal when creating your Ultravox call, e.g.
