...
**Model Training** → The Ultravox model is specifically trained to distinguish between primary and background speakers, understanding conversational context and speaker intent.
...
While background speaker filtering is enabled by default, you can disable it if needed:
