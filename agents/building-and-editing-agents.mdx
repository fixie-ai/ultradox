...
- **Inline instructions** for multi-step processes → [Guiding Agents](/agents-and-calls/guiding-agents)
- **Call stages** for completely different conversation phases → [Call Stages](/agents-and-calls/call-stages)
